...
namespace Infrastructure.DataAcces
{
    public class SocialMediaDbContext : IdentityDbContext<User>
    {
        ...
        public DbSet<Friendship1> Friendships { get; set; }
        ...
        public DbSet<Imager> Imager { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Friendships
            modelBuilder.Entity<Friendship1>(entity =>
            {
            ...
            modelBuilder.Entity<Posts>(entity =>
            {
                ...
                entity.HasMany<Comments>(c => c.Comments)
